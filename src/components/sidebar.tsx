  ...
  return (
    <>
      <button
        ...
        className="fixed top-3 left-3 z-40 rounded-lg border border-slate-200 bg-white p-2 text-slate-600 shadow-sm lg:hidden"
      ...
      >
        <div className="flex items-center gap-2 border-b border-slate-200 px-5 py-4">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-900">RecoverAI</p>
